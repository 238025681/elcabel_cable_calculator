...
public class ConductorController {
	...
	public String createNewConductor(@ModelAttribute ConductorBindModel cableModel, BindingResult bindingResult) {
		...
		return "redirect:/calc/conductor";
	}
	...
	@ResponseBody
	public String getAllConductorNames() throws IOException {

		return 
				this.gsonService
				.toJson(this.conductorService.findAllNames());
	}
